...
setup(
    ...
    install_requires=['Jinja2==2.11.3', 'setuptools==36.4.0', 'delegator.py==0.0.13', 'pytest==3.2.1', 'click==6.7', 'prompt_toolkit==1.0.15'],
    entry_points={
    ...
    zip_safe=True,
    license='MIT License',
    classifiers=['development status :: 4 - beta', 'topic :: utilities', 'topic :: software development :: libraries', 'intended audience :: developers', 'programming language :: python :: 3 :: only', 'environment :: console', 'operating system :: macos']
)